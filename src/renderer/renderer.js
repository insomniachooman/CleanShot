...
import { isSupportedImageFile, readFileAsDataUrl, loadImageFromDataUrl } from "./modules/file-utils.js";
import { clamp, hexToRgb, rgbToHex, parseRgbString, hslToRgb, rgbToHsl, parseHslString, parseColorString, formatColorForMode } from "./modules/color-utils.js";
...
const state = {
 ...
 // SUPPORTED_IMAGE_EXTENSIONS moved to modules/file-utils.js
...
/* moved to modules/file-utils.js: isSupportedImageFile */

/* moved to modules/file-utils.js: readFileAsDataUrl */
...
/* moved to modules/file-utils.js: loadImageFromDataUrl */

 // moved to modules/color-utils.js (clamp, hexToRgb, rgbToHex, parseRgbString, hslToRgb, rgbToHsl, parseHslString, parseColorString, formatColorForMode)
